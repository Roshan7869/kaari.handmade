  ...
  return (
    <div className="min-h-screen bg-kaari-cream/30 flex items-center justify-center px-4 py-16">
      <div className="w-full max-w-md bg-white rounded-lg shadow-lg p-8">
        <h1 className="font-display text-3xl text-kaari-dark mb-2 text-center">Welcome Back</h1>
        <p className="text-center text-kaari-dark/60 mb-8">Sign in to your Kaari account</p>
